...
main = do
  ...
  test "show time machine"
       (show $ TimeMachine "Tesla" (Model 3) (Name "The E in SEXY") (Future) (Price 35000.00))
       (==)
       "TimeMachine {manufacturer = \"Tesla\", model = Model 3, name = Name \"The E in SEXY\", travelDirection = Future, price = Price 35000.0}"
  ...
  test "applyPriceMultiplier 50% to two TimeMachines"
       (applyPriceMultiplier 0.5 [ TimeMachine "Tesla" (Model 3) (Name "The E in SEXY") (Future) (Price 35000.00)
                                 , TimeMachine "Tesla" (Model 1) (Name "The mass market") (Future) (Price 15000.00)
                                 ])
       (==)
       [ TimeMachine "Tesla" (Model 3) (Name "The E in SEXY") (Future) (Price 17500.00)
       , TimeMachine "Tesla" (Model 1) (Name "The mass market") (Future) (Price 7500.00)
       ]
